...
def generateFollowingTourMatchesParis(sortedList):
    matches = []
    while len(sortedList) >= 2:
        print("in the while")
        for j in range(1, len(sortedList), 1):
            print(j)
            print(sortedList[].opponent_list.name)
...
def generateMatchesPairsWithSwissSystem(playersList, isFirstTour):
    ...
    if isFirstTour:
        ...
        return generateFollowingTourMatchesParis(sortedList)
...
joueur1 = Player("Moncorger", "Thierry", "1983-02-18", "male", 4)
joueur2 = Player("Degtyarova", "Tetyana", "1984-04-06", "female", 4)
joueur3 = Player("Moncorger", "Alexandre", "2014-04-30", "male", 3)
joueur4 = Player("Moncorger", "Antoine", "2016-01-25", "male", 3)
joueur5 = Player("Moncorger", "Valentina", "2022-05-16", "female", 2)
joueur6 = Player("Moncorger", "Julie", "1980-09-19", "female", 2)
joueur7 = Player("Som", "François", "1984-06-06", "male", 1)
joueur8 = Player("Combette", "Tristan", "1990-09-15", "male", 1)
